...
public class add extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        setClosable(true);
        setTitle("Add New Data Karyawan");
    ...
    private void simpanBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_simpanBtnActionPerformed
        ...
        boolean save = false;
        try {
            save = karyawanCtrl.insertKaryawan(field);
        } catch (SQLException | IOException | PropertyVetoException ex) {
            Logger.getLogger(add.class.getName()).log(Level.SEVERE, null, ex);
        }

        if (save == true) {
            JOptionPane.showMessageDialog(this, "Selamat, Data anda berhasil tersimpan", "Sukses", 1);
            clearField();
        }
    ...
    private String autoNik() throws SQLException, IOException, PropertyVetoException {
//      int year = 
        Integer year = Calendar.getInstance().get(Calendar.YEAR);
        Integer month = Calendar.getInstance().get(Calendar.MONTH);
        String[] mt = {"01", "02", "03", "04", "05", "06", "07", "08", "09", "10", "11", "12"};
        String str = String.valueOf(year);
        String yr = str.substring(Math.max(str.length() - 2, 0));
        String uid, new_uid = "";
        Integer len = 3, uid_ = 0;
        pojoKaryawan rs = karyawanCtrl.view("", 0, "uid", 1, 1);
        uid_ = rs.getId(0);
        uid_ += 1;
        uid = String.valueOf(uid_);
        len = len - uid.length();
        for (int a = 0; a < len; a++) {
            new_uid = "0" + new_uid;
        }
        return yr + mt[month] + new_uid + uid;
    }
